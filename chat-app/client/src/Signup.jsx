    ...
    <div style={{ minHeight:'100vh', display:'flex', fontFamily:"'DM Sans',sans-serif", position:'relative', overflow:'hidden', background:'#07070f' }}>
      ...
      <div style={{ flex:1, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:'60px 48px', position:'relative', zIndex:1 }}>
        ...
        <div style={{
          ...
          borderRadius:20, padding:16, animation:'fadeSlideUp .7s .6s both', opacity:0,
          ...
          <div style={{ position:'relative', zIndex:1 }}>
            ...
            {step === 0 && (
              <>
                ...
                <h2 style={{ fontSize:27, fontWeight:800, color:'#fff', margin:'0 0 6px', fontFamily:"'Syne',sans-serif" }}>Create account</h2>
                <p style={{ color:'rgba(255,255,255,.35)', fontSize:13, marginBottom:28 }}>Set up your cosmic credentials</p>
                ...
                <div style={{ marginBottom:22 }}>
                  ...
                  <div style={{ position:'relative' }}>
                    <span style={{ position:'absolute', left:14, top:'50%', transform:'translateY(-50%)', fontSize:15, opacity:.5 }}>🔒</span>
                    <input type={showPass?'text':'password'} placeholder="Min. 6 characters" value={form.password} onChange={e=>update('password',e.target.value)} onKeyDown={e=>e.key==='Enter'&&next()} onFocus={()=>setFocused('password')} onBlur={()=>setFocused(null)} style={{...inp(focused,'password'), paddingRight:44}}/>
            ...
            {step === 1 && (
              <>
                ...
                <h2 style={{ fontSize:27, fontWeight:800, color:'#fff', margin:'0 0 6px', fontFamily:"'Syne',sans-serif" }}>Your identity</h2>
                <p style={{ color:'rgba(255,255,255,.35)', fontSize:13, marginBottom:28 }}>How the universe knows you</p>
            ...
            {step === 2 && (
              <div style={{ textAlign:'center', padding:'8px 0' }}>
                ...
                <h2 style={{ color:'#fff', fontSize:22, fontWeight:800, margin:'0 0 10px', fontFamily:"'Syne',sans-serif" }}>You're almost in!</h2>
                ...
                <div style={{ background:'rgba(129,140,248,0.07)', border:'1px solid rgba(129,140,248,0.2)', borderRadius:14, padding:'14px 18px', marginBottom:24, animation:'borderGlow 3s ease-in-out infinite' }}>
                  ...
                  <div style={{ color:'#a5b4fc', fontWeight:800, fontSize:22, fontFamily:"'Syne',sans-serif" }}>@{form.handle.trim().toLowerCase()}</div>
                </div>
            ...
            {step < 2 && (
              <>
                {error && <div style={{ background:'rgba(239,68,68,0.1)', border:'1px solid rgba(239,68,68,0.2)', borderRadius:12, padding:'10px 14px', marginBottom:16, color:'#fca5a5', fontSize:13 }}>⚠ {error}</div>}
